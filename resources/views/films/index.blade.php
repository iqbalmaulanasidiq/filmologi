...
<div class="container mx-auto px-4 py-16">
    ...
    <div class="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 px-5 py-5">
        <div class="flex justify-between items-center mb-4">
         ...
         {{-- start card --}}
         <div class="flex flex-wrap items-stretch overflow-hidden -mx-4 mt-4">
                ...
                <a href="movies/{{ $movieId }}" class="group block w-full md:w-[50%] lg:w-[33.33%] xl:w-[25%] mb-4 px-4 text-white">
