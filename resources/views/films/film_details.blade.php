...
<div class="w-full h-screen flex flex-row items-center justify-center relative">
    ...
    @php
        $backdropPath = "{$imageBaseURL}/original{$movieData['backdrop_path']}";
    @endphp
...
<div class="w-full h-screen absolute bg-black bg-opacity-80 z-10"></div>
    ...
    @if ($movieData)
        @php
            ...
            $tagline = isset($movieData['overview']) ? $movieData['overview'] : $movieData['tagline'];
    ...
    <div class="flex flex-row items-center mb-8">
        ...
        <div class="w-1/2">
            <div class="bg-white p-4 rounded-md shadow-md">
                <img src="{{ $imageBaseURL }}/w500{{ $movieData['poster_path'] }}" alt="Movie Poster"
...
<div class="absolute z-10 w-full h-screen p-20 bg-black flex flex-col" id="trailerWrapper">
    ...
    <iframe id="youtubeVideo" class="w-full h-screen" src="https://www.youtube.com/embed/{{ $trailerID }}?enablejsapi=1" title="{{ $movieData['title'] }}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
