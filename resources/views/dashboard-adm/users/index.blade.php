       ...
       <div class="flex items-center justify-left h-1 mb-4 rounded bg-white-50 dark:bg-white-800">
        ...
        <!-- Modal toggle Tambah -->
            <div class="flex space-x-4"> <!-- Use 'space-x-4' to add horizontal spacing between buttons -->
                ...
                <button class="block text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-green-300 dark:focus:ring-green-800 focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-4 py-2.5 text-center ml-4 pb-2 mt-6">PDF Reporting</button>
